...
require('styles//LiftingStateUp.css');
...
class LiftingStateUpComponent extends React.Component {
  constructor(props){
    super(props);
  ...
  render() {
    ...
    return (
      <div className="liftingstateup-component">
        <fieldSet>
...
LiftingStateUpComponent.displayName = 'LiftingStateUpComponent';

// Uncomment properties you need
// LiftingStateUpComponent.propTypes = {};
// LiftingStateUpComponent.defaultProps = {};
